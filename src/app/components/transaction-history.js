    ...
    const unsubscribe = onAuthStateChanged(auth, (user) => {
      if (user) {
        ...
        const filteredTransactions = transactions.filter((transaction) => {
          return transaction.receivedData && transaction.receivedData.userEmail === userEmail;
        });

        //console.log('Filtered Transactions Data:', filteredTransactions); // Log data transaksi yang sudah difilter
       ...
       // console.log('Merged Data:', mergedData); // Log data yang sudah digabungkan
